...
## 🖼️ Visualization
### Samples of zero-shot anomaly localization on crane data are shown below for both the main setting and the medical setting (discussed in Appendix D). The complete set of visualizations can be found in Appendix in the paper.
